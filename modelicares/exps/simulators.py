...
class _Simulator(object):
    ...
    **Parameters:**
    ...
    def __init__(self, **options):
        ...
        self.n_runs = 0
        self._run_log = open("runs.tsv", 'w')


    def __enter__(self):
        """Enter the context of the simulator.
        """
        # If everything has been done in __init__, just:
        return self
    ...
    **Initialization parameters (defaults in parentheses):**
    ...
    - *results* (['dsin.txt', 'dslog.txt', 'dsres.mat', 'dymolalg.txt'
      'dymosim%x']): Sequence of files to copy to the results folder
         ...
         The path is relative to the working directory.  '%x' may be included in
         the filename to represent '.exe' if the operating system is Windows and
